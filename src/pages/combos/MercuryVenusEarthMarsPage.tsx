...
const config = comboConfigs['mercury-venus-earth-mars']
...
export default function MercuryVenusEarthMarsPage() {
  const [activeTab, setActiveTab] = useState<string>('m1')
  const [items1, setItems1] = useLocalStorage<Item1[]>('mvem-items1', [])
  const [items2, setItems2] = useLocalStorage<Item2[]>('mvem-items2', [])
  const [items3, setItems3] = useLocalStorage<Item3[]>('mvem-items3', [])
  const [items4, setItems4] = useLocalStorage<Item4[]>('mvem-items4', [])
