...
const config = comboConfigs['mars-jupiter-saturn-neptune']
const PRIMARY_COLOR = config.primaryColor
const SECONDARY_COLOR = config.secondaryColor

const TAB_LIST = [
  { id: 'm1', name: '信念力量', icon: '🌌' },
  { id: 'm2', name: '梦想行动', icon: '🌟' },
  { id: 'm3', name: '坚持信念', icon: '💫' },
...
export default function MarsJupiterSaturnNeptunePage() {
