...
const config = comboConfigs['mars-jupiter-saturn-uranus-neptune']
...
export default function MarsJupiterSaturnUranusNeptunePage() {
  const [activeTab, setActiveTab] = useState<string>('m1')
  const [items1, setItems1] = useLocalStorage<Item1[]>('mars-items1', [])
  const [items2, setItems2] = useLocalStorage<Item2[]>('mars-items2', [])
  const [items3, setItems3] = useLocalStorage<Item3[]>('mars-items3', [])
  const [items4, setItems4] = useLocalStorage<Item4[]>('mars-items4', [])
