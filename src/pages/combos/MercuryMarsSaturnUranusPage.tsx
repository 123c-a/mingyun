...
const config = comboConfigs['mercury-mars-saturn-uranus']
...
export default function MercuryMarsSaturnUranusPage() {
  const [activeTab, setActiveTab] = useState<string>('m1')
  const [items1, setItems1] = useLocalStorage<Item1[]>('mmsu-items1', [])
  const [items2, setItems2] = useLocalStorage<Item2[]>('mmsu-items2', [])
  const [items3, setItems3] = useLocalStorage<Item3[]>('mmsu-items3', [])
  const [items4, setItems4] = useLocalStorage<Item4[]>('mmsu-items4', [])
