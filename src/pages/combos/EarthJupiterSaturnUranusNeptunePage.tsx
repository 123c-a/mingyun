...
const config = comboConfigs['earth-jupiter-saturn-uranus-neptune']
...
export default function EarthJupiterSaturnUranusNeptunePage() {
  const [activeTab, setActiveTab] = useState<string>('m1')
  const [items1, setItems1] = useLocalStorage<Item1[]>('eart-items1', [])
  const [items2, setItems2] = useLocalStorage<Item2[]>('eart-items2', [])
  const [items3, setItems3] = useLocalStorage<Item3[]>('eart-items3', [])
  const [items4, setItems4] = useLocalStorage<Item4[]>('eart-items4', [])
