...
const config = comboConfigs['mars-jupiter-uranus-neptune']
const PRIMARY_COLOR = config.primaryColor
const SECONDARY_COLOR = config.secondaryColor

const TAB_LIST = [
  { id: 'm1', name: '无限可能', icon: '🌌' },
  { id: 'm2', name: '灵感行动', icon: '🌟' },
  { id: 'm3', name: '量子跃迁', icon: '💫' },
  { id: 'm4', name: '创造现实', icon: '✨' },
]
...
export default function MarsJupiterUranusNeptunePage() {
