...
const config = comboConfigs['venus-jupiter-saturn-uranus-neptune']
...
export default function VenusJupiterSaturnUranusNeptunePage() {
  const [activeTab, setActiveTab] = useState<string>('m1')
  const [items1, setItems1] = useLocalStorage<Item1[]>('venu-items1', [])
  const [items2, setItems2] = useLocalStorage<Item2[]>('venu-items2', [])
  const [items3, setItems3] = useLocalStorage<Item3[]>('venu-items3', [])
  const [items4, setItems4] = useLocalStorage<Item4[]>('venu-items4', [])
