...
const config = comboConfigs['mercury-jupiter-saturn-uranus']
const PRIMARY_COLOR = config.primaryColor
const SECONDARY_COLOR = config.secondaryColor

const TAB_LIST = [
  { id: 'm1', name: '认知盲区', icon: '🌌' },
  { id: 'm2', name: '思维跃迁', icon: '🌟' },
  { id: 'm3', name: '突破验证', icon: '💫' },
  { id: 'm4', name: '认知升级', icon: '✨' },
]
...
export default function MercuryJupiterSaturnUranusPage() {
