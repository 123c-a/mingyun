...
const config = comboConfigs['venus-earth-saturn-uranus']
...
export default function VenusEarthSaturnUranusPage() {
  const [activeTab, setActiveTab] = useState<string>('m1')
  const [items1, setItems1] = useLocalStorage<Item1[]>('vesu-items1', [])
  const [items2, setItems2] = useLocalStorage<Item2[]>('vesu-items2', [])
  const [items3, setItems3] = useLocalStorage<Item3[]>('vesu-items3', [])
  const [items4, setItems4] = useLocalStorage<Item4[]>('vesu-items4', [])
