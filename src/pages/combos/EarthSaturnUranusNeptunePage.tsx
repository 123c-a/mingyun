...
const config = comboConfigs['earth-saturn-uranus-neptune']
...
export default function EarthSaturnUranusNeptunePage() {
  const [activeTab, setActiveTab] = useState<string>('m1')
  const [items1, setItems1] = useLocalStorage<Item1[]>('esun-items1', [])
  const [items2, setItems2] = useLocalStorage<Item2[]>('esun-items2', [])
  const [items3, setItems3] = useLocalStorage<Item3[]>('esun-items3', [])
  const [items4, setItems4] = useLocalStorage<Item4[]>('esun-items4', [])
